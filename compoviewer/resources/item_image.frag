...
void main(){
	...
	c.rgba = 
		...
		||(p.x*image_resolution.x+2.0)/image_resolution.x<0.0||(p.y*image_resolution.y-2.0)/image_resolution.y>1.0||(p.x*image_resolution.x-2.0)/image_resolution.x>1.0?texture2D(tex, vec2(0.5), 10.0):vec4(0.0);
